...
class OrderController extends BaseController {
    ...
    public function ajaxindex(){
        ...
        $show = $Page->show();
        //获取订单列表
        $orderLists = $orderLogic->getOrderList($condition,$sort_order,$Page->firstRow,$Page->listRows);
        // foreach ($orderLists as $ol => $ols) {
        //     if($ols['shop'] == "1" || $ols['shop'] == "2"){
        //         $orderList[] = $ols;
        //     }
        // }
        // print_r($orderLists);
