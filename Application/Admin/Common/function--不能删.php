...
function getAllMenu(){
	return	array(
			...
			'books' => array('name' => 'UU册管理', 'icon'=>'fa-book', 'sub_menu' => array(
			...
			'tourism' => array('name' => 'UU旅游', 'icon'=>'fa-book', 'sub_menu' => array(
			...
			'planning' => array('name' => 'U企划', 'icon'=>'fa-comments', 'sub_menu' => array(
					array('name' => '关于我们', 'act'=>'aboutList', 'control'=>'Planning'),
			...
			// 'service' => array('name' => '客服中心', 'icon'=>'fa-book', 'sub_menu' => array(
			// 		array('name' => '游换购客服', 'act'=>'hgservice', 'control'=>'Service'),
			// )),
			...
			// )),
			// 'pickup' => array('name' => '自提点管理', 'icon'=>'fa-signal', 'sub_menu' => array(
