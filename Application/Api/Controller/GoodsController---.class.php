...
class GoodsController extends BaseController {
    ...
    public function goodsCategoryList(){        
        ...
        $replace = array('src=&quot;\/'.yuming.'\/Public','"'.yuming.'\/Public');
...
// $sql = M('goods')->getLastSql();echo $sql;
    ...
    public function indexgoods(){
        ...
        // print_r($rule);die();
        $seasgoods = M('Goods_')->where("rule=".$rule ." and ". "area=1")->order('goods_id desc')->limit("3")->select();
        // $sql = M('Goods_')->getLastSql();echo $sql;
        // print_r($seasgoods);die();
        //换购专区
        $rule2 = I("post.rule2");
        if(empty($rule2)){
            $rule2 = "100";
        ...
        $buysgoods = M('Goods_')->where("rule=".$rule2 ." and ". "area=2")->order('goods_id desc')->limit("7")->select();
        ...
        $specgoods = M('Goods_')->where("rule=".$rule3 ." and ". "area=3")->order('goods_id desc')->limit("7")->select();
        ...
        $customgoods = M('Goods_')->where("rule=".$rule4 ." and ". "area=4")->order('goods_id desc')->limit("3")->select();
    ...
    public function caifu(){
        ...
        //导航
        $you_shop = M("introductions")->where("type=1")->find();
        $you_ce = M("introductions")->where("type=2")->find();
        $json_arr = array('status'=>1,'msg'=>'获取成功','uubans'=>$uubans,'first_title'=>$first_title,'you_shop'=>$you_shop,'you_ce'=>$you_ce);
        $replace = array('src=&quot;\/'.yuming.'\/Public','"'.yuming.'\/Public');
        $search = array('src=&quot;\/Public','"\/Public');
        $json_str = json_encode($json_arr,TRUE); 
        // var_dump($json_str);
